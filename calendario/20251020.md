...
[file](../codice/12.checkstring.1.py)
...
[file](../codice/12.checkstring.2.py)
...
[file](../codice/12.checkstring.3.py)
...
[file](../codice/12.checkstring.4.py)
...
[file](../codice/13.bidirectionalstring.1.py)
...
[file](../codice/13.bidirectionalstring.2.py)

> Solution 3 **python-like solution**
> This is not what the problem wants to exercise ...
...
[file](../codice/13.bidirectionalstring.3.py)
...
[file](../codice/14.reversecomplement.1.py)
...
[file](../codice/14.reversecomplement.2.py)
...
[file](../codice/15.largerthanaverage.1.py)
...
[file](../codice/15.largerthanaverage.2.py)
...
Write a python program that acquires a string. For each character `car` contained in the sequence, starting from the last to the first, the program displays (without leaving spaces) the character `car`, followed by the number of times it appears consecutively at that point in the string. For example, if the user enters `zzbbbddbbbbhhhhhzzzz` the program displays `z4h5b4d2b3z2`.
